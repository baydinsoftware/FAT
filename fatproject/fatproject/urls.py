...
class FeedbackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Feedback
        fields = ('rating', 'secret', 'date_updated', 
            'form', 'author', 'candidate', 'stage', 'id', 'answers', 'author_name', 'notes', 'picture_url')
...
class CandidateSerializer(serializers.ModelSerializer): 
    ...
    class Meta:
        model = Candidate
        fields = ('url', 'name', 'email', 'date_added', 
                    'stage', 'id', 'waiting', 'position', 
                    'owner', 'archived', 'last_marked_waiting', 
                    'owner_name', 'stage_name', 'position_name', 'files',
                    'feedbackCollection', 'actions' )
        # depth = 2
...
class PositionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Position
        fields = ('name', 'candidates', 'archived', 'department', 
                    'department_name', 'id', 'description',)
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('username', 'candidates', 'id', 'password', 'last_login', 'is_superuser', 'userprofile',
...
class FormSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FeedbackForm
        fields = ('rating_type', 'name', 'secret_by_default', 
                  'questions', 'id', 'active', 'feedbacks')
